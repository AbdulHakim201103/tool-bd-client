...
const Footer = () => {
  ...
  return (
    <div className="container mx-auto">
      <footer className="footer footer-center p-10 bg-neutral lg:flex lg:justify-around items-center  text-neutral-content">
        <div>
      ...
      <footer className="footer footer-center p-10 bg-neutral text-neutral-content rounded">
        ...
        <div>
          <p>Copyright &copy; {year} - All right reserved by ToolsBD Industries Ltd</p>
        </div>
      </footer>
    </div>
  );
